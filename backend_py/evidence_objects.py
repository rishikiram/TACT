...
def get_potential_X_comparator_groups(study_nctids: list[str], ) -> list[dict]:
    with aact.connect_aact() as conn:
        cur = conn.cursor()
        cur.execute(
            """
